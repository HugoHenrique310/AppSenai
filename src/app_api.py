...
from flet import ThemeMode, View, Colors, ListView, Icons, ListTile, Image, Column, Text, \
    Pagelet, NavigationBar, NavigationBarDestination, ScrollMode, FontWeight, Card, Row, TextOverflow
                    ...
                    content=Row([
                        ...
                        Row([
                            Column([
                                ...
                                Text(f"Base KI", weight=FontWeight.BOLD, color=Colors.BLUE),
                            ...
                            Column([
                                ...
                                Text(f"Total KI", weight=FontWeight.BOLD, color=Colors.GREEN),
        ...
        for item in lista_dados["items"]:
            list_view.controls.append(
                ListTile(
                    ...
                    title=Text(item["name"], weight=FontWeight.BOLD, color=Colors.PURPLE),
